                    ...
                    <div class="big_deals_slider_btn">
                        ...
                        <div class="swiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <button type="button" class="tablinks3" onclick="openTab3(event, 'bigTabSlider2')">
                                        New Arrival
                                    </button>
                                </div>
                                <div class="swiper-slide">
                                    <button type="button" class="tablinks3" onclick="openTab3(event, 'bigTabSlider3')">
                                        Most Viewed
                                    </button>
                                </div>
                                <div class="swiper-slide">
                                    <button type="button" class="tablinks3" onclick="openTab3(event, 'bigTabSlider4')">
                                        Deal of the Season
                                    </button>
                                </div>
                                <div class="swiper-slide">
                                    <button type="button" class="tablinks3" onclick="openTab3(event, 'bigTabSlider5')">
                                        Big Needs
                                    </button>
                                </div>
                                <div class="swiper-slide">
                                    <button type="button" class="tablinks3" onclick="openTab3(event, 'bigTabSlider6')">
                                        Big Quantity
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product_item product_item2">
                                            <a href="{{ route('front.productDetails', ['slug' => $bestDeal->slug]) }}"
                                                class="product_img hover_color">
                                                <img src="{{ asset('assets/images/placeholderbg.png') }}"
                                                    data-original="{{ $bestDeal->thumbnail }}"
                                                    onerror="this.onerror=null;this.src='{{ asset('assets/images/placeholderbg.png') }}';" />
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product_item product_item2">
                                            <a href="{{ route('front.productDetails', ['slug' => $bdNewArrival->slug]) }}"
                                                class="product_img hover_color">
                                                <img src="{{ asset('assets/images/placeholderbg.png') }}"
                                                    data-original="{{ $bdNewArrival->thumbnail }}"
                                                    onerror="this.onerror=null;this.src='{{ asset('assets/images/placeholderbg.png') }}';" />
                                                <div class="offer_text">Bennebos Offer</div>
                                            </a>
                                            <div class="product_content">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product_ratting_area">
                                                        ...
                                                        <span>({{ product_review($bdNewArrival->id) }} Reviews)</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product_item product_item2">
                                            <a href="{{ route('front.productDetails', ['slug' => $bdMostViewed->slug]) }}"
                                                class="product_img hover_color">
                                                <img src="{{ asset('assets/images/placeholderbg.png') }}"
                                                    data-original="{{ $bdMostViewed->thumbnail }}"
                                                    onerror="this.onerror=null;this.src='{{ asset('assets/images/placeholderbg.png') }}';" />
                                                <div class="offer_text">Bennebos Offer</div>
                                            </a>
                                            <div class="product_content">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product_ratting_area">
                                                        ...
                                                        <span>({{ product_review($bdMostViewed->id) }} Reviews)</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product_item product_item2">
                                            <a href="{{ route('front.productDetails', ['slug' => $bdDealOfSeason->slug]) }}"
                                                class="product_img hover_color">
                                                <img src="{{ asset('assets/images/placeholderbg.png') }}"
                                                    data-original="{{ $bdDealOfSeason->thumbnail }}"
                                                    onerror="this.onerror=null;this.src='{{ asset('assets/images/placeholderbg.png') }}';" />
                                                <div class="offer_text">Bennebos Offer</div>
                                            </a>
                                            <div class="product_content">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product_ratting_area">
                                                        ...
                                                        <span>({{ product_review($bdDealOfSeason->id) }} Reviews)</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product_item product_item2">
                                            <a href="{{ route('front.productDetails', ['slug' => $bdBigNeeds->slug]) }}"
                                                class="product_img hover_color">
                                                <img src="{{ asset('assets/images/placeholderbg.png') }}"
                                                    data-original="{{ $bdBigNeeds->thumbnail }}"
                                                    onerror="this.onerror=null;this.src='{{ asset('assets/images/placeholderbg.png') }}';" />
                                                <div class="offer_text">Bennebos Offer</div>
                                            </a>
                                            <div class="product_content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product_item product_item2">
                                            <a href="{{ route('front.productDetails', ['slug' => $bdBigQuantity->slug]) }}"
                                                class="product_img hover_color">
                                                <img src="{{ asset('assets/images/placeholderbg.png') }}"
                                                    data-original="{{ $bdBigQuantity->thumbnail }}"
                                                    onerror="this.onerror=null;this.src='{{ asset('assets/images/placeholderbg.png') }}';" />
                                                <div class="offer_text">Bennebos Offer</div>
                                            </a>
                                            <div class="product_content">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product_ratting_area">
                                                        ...
                                                        <span>({{ product_review($bdBigQuantity->id) }} Reviews)</span>
                                                    </div>
                                                </div>
