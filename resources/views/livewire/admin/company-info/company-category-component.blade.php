                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 col-sm-12 mb-2 search_cont">
                                ...
                                <input type="search" class="sinput" placeholder="Search" wire:model="searchTerm" wire:keyup='changeSearch' />
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table custom_tbl">
                                ...
                                <tbody>
                                    @php
                                    $sl = ($categories->perPage() *
                                    $categories->currentPage())-($categories->perPage() - 1)
                                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="button-items">
                                                        <a href="#" type="button" class="btn btn-outline-primary btn-icon-circle btn-icon-circle-sm" wire:click.prevent="editData({{ $category->id }})"><i class="ti ti-edit"></i></a>
                                                        <a href="#" type="button" class="btn btn-outline-danger btn-icon-circle btn-icon-circle-sm" wire:click.prevent="deleteConfirmation({{ $category->id }})"><i class="ti ti-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-11">
                            <form wire:submit.prevent="@if($formStatus == 'Update') updateData @else storeData @endif">
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Category Id</label>
                                    <div class="col-sm-9">
