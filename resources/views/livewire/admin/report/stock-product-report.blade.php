                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Stock Product Report</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Stock Product Report</h4>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row mb-3">
                            <div class="col-sm-8">
                                <div class="row mb-3">
                                    <label class="col-sm-3 col-form-label" for="product">Prodcut Stcok Report</label>
                                    <div class="col-sm-9">
                                        <div wire:ignore>
                                            <select class="form-control" id="category" wire:model="stock_category_filter">
                                                <option value="">Select Prodcut Category</option>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table custom_tbl">
                            ...
                            <tbody>
                                @php
                                $sl = $stockProduct->perPage() * $stockProduct->currentPage() -
                                ($stockProduct->perPage() - 1);
                                @endphp
                    ...
                    {{ $stockProduct->links('pagination-links-table') }}
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#category').on('change', function() {
            @this.set('stock_category_filter', $(this).val());
        });
    });
</script>
@endpush