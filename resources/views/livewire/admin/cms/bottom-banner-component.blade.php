<div>
                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Bottom Banner</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">All Bottom Banner</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table custom_tbl">
                                ...
                                <tbody>
                                    @php
                                    $sl = ($bottomBanners->perPage() * $bottomBanners->currentPage())-($bottomBanners->perPage() - 1)
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td><img style="height: 50px; width: 150px;"
                                                src="{{ $bottomBanner->banner }}" alt=""></td>
                                        <td>{{ $bottomBanner->title }}</td>
                                        <td style="text-align: center;">
                                            <div class="button-items">
                                                <a type="button" href="#" class="btn btn-sm btn-outline-success"
                                                    wire:click.prevent="editData({{ $bottomBanner->id }})">Edit</a>
                                                <a wire:click.prevent="deleteConfirmation({{ $bottomBanner->id }})"
                        ...
                        {{ $bottomBanners->links('pagination-links-table') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add New Bottom Banner</h5>
    ...
    <div wire:ignore.self class="modal fade" id="editDataModal" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Bottom Banner</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
<script>
    //Success Delete
    window.addEventListener('bottomBannerDeleted', event => {
            Swal.fire(
                'Deleted!',
