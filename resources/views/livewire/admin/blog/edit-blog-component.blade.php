                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active-item">Edit Blog</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-7 col-md-10">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.allBlogs') }}" class="card-button btn btn-sm btn-primary" style="padding: 1px 7px;"><i class="ti ti-list"></i> All Blogs</a>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @elseif ($uploadedBanner)
                                        <img src="{{ $uploadedBanner }}" width="80" class="mt-2 mb-2"  alt="">
                                    @endif
                                </div>
                            </div>
