<div>
    <!-- Newsletter Section  -->
    <section class="newsletter_wrapper default_section_gap" @if (!request()->is('/')) style="display:none;" @endif > 
        <div class="my-container">
            <div class="newsletter_form_area">
                <h3>{{ __('auth.subscribe_newsletter') }}</h3>
                <form id="newsletterForm">
                    <div class="input_row">
                        <input type="text" id='newsletterEmail' placeholder="{{ __('auth.subscribe_email') }}" />
                    </div>
            ...
            <div class="footer_grid_area">
                <div class="footer_logo_area">
                    <a href="{{ route('home.index') }}">
                        <img src="{{ $setting->footer_logo }}" alt="Footer logo" />
                    </a>
                ...
                <div class="footer_menu_area">
                    ...
                    <ul class="footer_menu_list">
                        ...
                        <li><a href="https://play.google.com/store/apps/details?id=com.bennebos_market&gl=TR">{{ __('auth.our_apps') }}</a></li>
                ...
                <div class="footer_menu_area">
                    ...
                    <ul class="footer_menu_list">
                        <li><a href="{{ route('reports', ['slug' => 'turkey', 'type'=>'import']) }}">{{
                                __('auth.our_service') }}</a></li>
                ...
                <div class="footer_menu_area">
                    ...
                    <ul class="footer_app_list">
                        <li>
                            <a href="https://play.google.com/store/apps/details?id=com.bennebos_market&gl=TR" target="_blank" class="download_app_area">
                                <div class="app_icon">
                                    <img src="{{ asset('assets/front/images/icon/google_play_icon.svg') }}" alt="google play icon" />
                                </div>
                        ...
                        <li>
                            <a href="#" target="_blank" class="download_app_area">
                                <div class="app_icon">
                                    <img src="{{ asset('assets/front/images/icon/apple_play_icon.svg') }}" alt="apple play icon" />
                                </div>
                                <div class="download_content">
                                    <h5>{{ __('auth.download_by') }}</h5>
