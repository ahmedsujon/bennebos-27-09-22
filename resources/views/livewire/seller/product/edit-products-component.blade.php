@section('page_title')
  {{ __('seller.edit_product_top_title') }}
@endsection
<div>
    <style>
        #customSwitchSuccess {
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" style="padding: 3px 10px;" class="btn btn-primary mb-1 @if($tabStatus == 1 || $tabStatus == 2 || $tabStatus == 3 || $tabStatus == 4) active @endif">@if($tabStatus == 1 || $tabStatus == 2 || $tabStatus == 3 || $tabStatus == 4)<i class="ti ti-check"></i> @endif {{ __('seller.information') }}</button>

                                <button type="button" style="padding: 3px 10px;" class="btn btn-primary mb-1 @if($tabStatus == 2 || $tabStatus == 3 || $tabStatus == 4) active @elseif($tabStatus == 1)  @else disabled @endif">@if($tabStatus == 2 || $tabStatus == 3 || $tabStatus == 4)<i class="ti ti-check"></i> @endif {{ __('seller.price_stock') }}</button>

                                <button type="button" style="padding: 3px 10px;" class="btn btn-primary mb-1 @if($tabStatus == 3 || $tabStatus == 4) active @elseif($tabStatus == 2)  @else disabled @endif">@if($tabStatus == 3 || $tabStatus == 4)<i class="ti ti-check"></i> @endif {{ __('seller.description') }}</button>

                                <button type="button" style="padding: 3px 10px;" class="btn btn-primary mb-1 @if($tabStatus == 4) active @elseif($tabStatus == 3)  @else disabled @endif">@if($tabStatus == 4)<i class="ti ti-check"></i> @endif {{ __('seller.gallery') }}</button>

                                <button type="button" style="padding: 3px 10px;" class="btn btn-primary mb-1 @if($tabStatus == 4)  @else disabled @endif">{{ __('seller.metas') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="discount" placeholder="{{ __('seller.placeholder_enter_discount') }}"
                                        wire:model="discount" />
                                    @error('discount')
                                        <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-sm-3 col-form-label" for="gallery_images">{{ __('seller.thumbnail_image') }}<span class="text-danger">{{ __('seller.add_new_star') }}</span></label>
                                                <div class="col-sm-9">
                                                    <div wire:ignore>
                                            ...
                                            <div class="row mb-3 @if($galleryType != '1') d-none @endif">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div wire:loading="gallery_images" wire:target="gallery_images" wire:key="gallery_images" style="font-size: 12.5px;" class="mr-2"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> {{ __('seller.uploading') }}</div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" class="form-control" style="height: 200px;" id="meta_description" placeholder="{{ __('seller.placeholder_enter_meta_description') }}"
    ...
    <div wire:ignore class="modal" id="uploadThumbnailModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('seller.product_thumbnail') }}l</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
