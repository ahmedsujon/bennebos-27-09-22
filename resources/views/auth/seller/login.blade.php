                ...
                <div class="my-container">
                    <div class="sign_up_grid">
                        ...
                        <div class="sign_up_form_area">
                            <form action="{{ route('seller.login') }}" method="POST" class="form_area">
                                @csrf
                                ...
                                <div class="input_row">
                                    ...
                                    <input type="password" name="password" placeholder="Enter your password" id="password_input1" required>
                                    ...
                                    <li>
                                        <button type="button">
                                            <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M14.7998 0V3.6H12.9998C12.3788 3.6 12.0998 4.329 12.0998 4.95V7.2H14.7998V10.8H12.0998V18H8.4998V10.8H5.7998V7.2H8.4998V3.6C8.4998 1.61177 10.1116 0 12.0998 0H14.7998Z"
                                                    fill="black" />
                                            </svg>
                            ...
                            <h6 class="already_account">Do you have an account?<a href="sign-up.html">Sign Up For Here</a>
                            </h6>
                        </div>
                    </div>
                </div>
